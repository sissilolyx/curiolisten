# 原声精听｜AI 英语精听 · YouTube 与播客听力训练

**把你想听懂的视频、播客和会议，变成每天能练的英语。**

导入一段英文原声，先听、再听写和核对；听不懂的句子，让 AI 结合上下文解释。把值得记住的表达留到复习里，下次继续从上次的位置练。

**AI English listening practice for YouTube, podcasts, and real conversations.** Practice dictation, get sentence-by-sentence explanations, and review useful expressions on your Mac.

[开始安装](#最简单把-github-链接交给-codex-或-cursor) · [查看界面](#产品一览) · [常见问题](#使用前你可能想问) · [English](README.en.md) · [反馈问题](https://github.com/sissilolyx/meeting-listening-lab/issues)

macOS 本地运行 · Whisper 本地转写 · 自选 Codex / Cursor 讲解 · 源码公开，非商业许可
